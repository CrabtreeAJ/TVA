...
def ATVA4_strat_voting_all(voting_system: VotingSystem, basic_happiness, happiness):
    ...
    return strat_vote_sit


def ATVA4_compromise(voting_system: VotingSystem):
...
def ATVA4_burying(voting_system: VotingSystem):
...
def ATVA4_bullet_voting(voting_system: VotingSystem):
